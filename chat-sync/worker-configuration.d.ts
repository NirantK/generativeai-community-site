/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=chat-sync/wrangler.jsonc --strict-vars=false chat-sync/worker-configuration.d.ts` (hash: 1ce5de7e9371d1713ec9c51214d21ac4)
// Runtime types generated with workerd@1.20260915.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	STATE: R2Bucket;
	DB: D1Database;
	SYNC_ENABLED: string;
	WACLI: DurableObjectNamespace<import("./src/index").WhatsAppContainer>;
	SYNC: Workflow<Parameters<import("./src/index").ChatSyncWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WhatsAppContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_ENABLED">> {}
}
