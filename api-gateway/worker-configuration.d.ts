/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=api-gateway/wrangler.jsonc --strict-vars=false --env-interface=ApiGatewayEnv api-gateway/worker-configuration.d.ts` (hash: 934597852f074d9a6a9cf1dcfd9de137)
// Runtime types generated with workerd@1.20260915.1 2026-09-22 
interface __BaseEnv_ApiGatewayEnv {
	SITE_URL: string;
	ADMISSIONS: Service /* entrypoint AdmissionsGateway from genaicommunity-admissions-staging */ | Service /* entrypoint AdmissionsGateway from genaicommunity-admissions */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		SITE_URL: string;
		ADMISSIONS: Service /* entrypoint AdmissionsGateway from genaicommunity-admissions-staging */;
	}
	interface Env extends __BaseEnv_ApiGatewayEnv {}
}
interface ApiGatewayEnv extends __BaseEnv_ApiGatewayEnv {}
