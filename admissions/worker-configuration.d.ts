/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=admissions/wrangler.jsonc --strict-vars=false admissions/worker-configuration.d.ts` (hash: e1e8f04afda1fa69093aedab96f27802)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AdmissionAgent";
	}
